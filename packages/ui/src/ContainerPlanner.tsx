...
const CARGO_ITEMS: CargoType[] = [
  ...
  {
    name: "Palet Industrial (1.2x1.0m)",
    length: 1.2,
    width: 1.0,
    height: 1.4,
    weight: 1.0,
  ...
  {
    name: "Caja Carga Pesada (1.0x1.0m)",
    length: 1.0,
    width: 1.0,
    height: 1.0,
    weight: 2.0,
...
export function ContainerPlanner() {
  ...
  const [manifest] = useState<ManifestItem[]>([
    ...
    {
      id: "C-B",
      clientName: "Cliente B (Industrial)",
      cargoIdx: 1,
      quantity: 5,
    },
    {
      id: "C-C",
      clientName: "Cliente C (Maquinaria)",
      cargoIdx: 3,
      quantity: 2,
    },
  ]);
  ...
  const packingResult = useMemo(() => {
    ...
    const volUtilPercent = Math.min(
      (packedVolume / container.volume) * 100,
      100,
    );
    ...
    const cogX =
      itemsPacked > 0 ? sumWeightedX / totalWeight : container.length / 2;
    const cogDeviationPercent =
      ((cogX - container.length / 2) / (container.length / 2)) * 100;
                ...
                >
                  ...
                  >
                    ...
                    <span style={{ fontSize: "0.75rem", opacity: 0.8 }}>
                      {c.length}m L x {c.width}m W x {c.height}m H •{" "}
                      {c.maxWeight} Tons máx
                    </span>
                  </div>
                </button>
              ))}
              ...
              {manifest.map((m) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <strong style={{ color: cargo.color }}>
                        {m.clientName}
                      </strong>
                      <span
                        style={{
          ...
          <div style={{ marginTop: "0.5rem" }}>
            {packingResult.leftOut > 0 ? (
              ...
              >
                ...
                >
                  ¡Capacidad Excedida! {packingResult.leftOut} bultos quedaron
                  fuera.
                </span>
              </div>
              ...
              >
                ...
                >
                  Peso límite crítico superado (
                  {packingResult.weightUtilPercent.toFixed(0)}%).
                </span>
              </div>
            ) : (
              <div
        ...
        >
            ...
            >
              ...
              >
                ...
                <h4 style={{ fontWeight: "bold" }}>
                  Simulador Tridimensional de Estiba LCL
                </h4>
              </div>
          ...
          <div className="report-kpi-grid">
            <div className="kpi-panel-card">
              ...
              <h2 className="kpi-value text-accent">
                {packingResult.volUtilPercent.toFixed(1)}%
              </h2>
              <span className="kpi-detail">
                Volumen cargado vs total: {container.volume}m³
              </span>
            </div>
            ...
            <div className="kpi-panel-card">
              ...
              <span className="kpi-detail">
                Peso cargado: {packingResult.totalWeight.toFixed(1)}T /{" "}
                {container.maxWeight}T
              </span>
            </div>
            ...
            <div className="kpi-panel-card">
              ...
              <span className="kpi-detail">
                {packingResult.leftOut} bultos en cola de espera
              </span>
            </div>
            ...
            <div className="kpi-panel-card">
              ...
              <h2
                className="kpi-value"
                style={{
                  color: packingResult.isCenterHeavy ? "#f59e0b" : "#10b981",
                  fontSize: "1.5rem",
                  lineHeight: "2.8rem",
                }}
              >
              ...
              <span className="kpi-detail">
                Desviación: {packingResult.cogDeviationPercent.toFixed(1)}% del
                centro
              </span>
            </div>
          </div>
