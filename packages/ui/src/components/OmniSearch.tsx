          ...
          <div className="w-full max-w-xl bg-white border border-slate-200 rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            ...
            >
              ...
              <Command.List className="max-h-[300px] overflow-y-auto p-2">
                ...
                <Command.Group
                  heading="Navigation"
                  className="text-xs font-semibold text-slate-400 mb-2 px-2"
                >
                  <Command.Item
                    onSelect={() => handleSelect("/")}
                    className="flex items-center gap-3 px-3 py-2 mt-1 text-sm text-slate-700 hover:bg-indigo-50 hover:text-indigo-700 rounded-lg cursor-pointer aria-selected:bg-indigo-50 aria-selected:text-indigo-700"
                  >
                    <LayoutDashboard className="w-4 h-4" />
                    Dashboard
                  </Command.Item>
                  <Command.Item
                    onSelect={() => handleSelect("/globe")}
                    className="flex items-center gap-3 px-3 py-2 mt-1 text-sm text-slate-700 hover:bg-indigo-50 hover:text-indigo-700 rounded-lg cursor-pointer aria-selected:bg-indigo-50 aria-selected:text-indigo-700"
                  >
                  ...
                  <Command.Item
                    onSelect={() => handleSelect("/esg-tracker")}
                    className="flex items-center gap-3 px-3 py-2 mt-1 text-sm text-slate-700 hover:bg-indigo-50 hover:text-indigo-700 rounded-lg cursor-pointer aria-selected:bg-indigo-50 aria-selected:text-indigo-700"
                  >
                ...
                <Command.Group
                  heading="Shipments"
                  className="text-xs font-semibold text-slate-400 mb-2 px-2 mt-4"
                >
                  <Command.Item
                    onSelect={() => handleSelect("/bookings")}
                    className="flex items-center gap-3 px-3 py-2 mt-1 text-sm text-slate-700 hover:bg-slate-100 rounded-lg cursor-pointer aria-selected:bg-slate-100"
                  >
