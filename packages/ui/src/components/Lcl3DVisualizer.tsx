...
interface Lcl3DVisualizerProps {
  containerSpec: { length: number; width: number; height: number; name: string };
  packedItems: PackedItem[];
}

export function Lcl3DVisualizer({ containerSpec, packedItems }: Lcl3DVisualizerProps) {
  ...
  return (
    <div style={{ width: "100%", height: "100%", minHeight: "400px", borderRadius: "12px", overflow: "hidden", background: "#0f172a" }}>
      <Canvas camera={{ position: [cWidth * 1.5, cHeight * 1.5, cLength * 1.2], fov: 45 }}>
