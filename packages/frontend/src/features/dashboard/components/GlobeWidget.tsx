...
export function GlobeWidget() {
  ...
  return (
    <div className="rounded-3xl bg-slate-900/40 backdrop-blur-xl border border-white/10 overflow-hidden shadow-xl h-full flex flex-col relative group min-h-[400px]">
      ...
      <div
        className="absolute top-[30%] left-[45%] w-3 h-3 bg-blue-400 rounded-full shadow-[0_0_20px_#60a5fa] z-0 animate-pulse"
        style={{ animationDelay: "0.5s" }}
      />
      <div
        className="absolute top-[60%] left-[75%] w-2 h-2 bg-purple-400 rounded-full shadow-[0_0_15px_#c084fc] z-0 animate-pulse"
        style={{ animationDelay: "1s" }}
      />
      <div
        className="absolute top-[50%] left-[60%] w-2.5 h-2.5 bg-amber-400 rounded-full shadow-[0_0_15px_#fbbf24] z-0 animate-pulse"
      ...
      <div className="absolute top-6 left-6 z-20">
        ...
        <p className="text-slate-400 text-sm mt-1">
          Live tracking of fleet & cargo (2D Map)
        </p>
      </div>
