...
export function QuoteWizardModal({
  ...
  return (
    <Modal
      ...
      onClose={closeModal}
      hideCloseButton
      bodyClassName="p-0 bg-slate-50 flex flex-col h-full"
    >
      {/* Header */}
      <div className="bg-indigo-950 p-6 text-white flex justify-between items-center relative shrink-0">
        ...
        <Button
          onClick={closeModal}
          variant="ghost"
          className="relative z-10 text-white/50 hover:text-white h-auto p-0"
        >
          <X className="w-6 h-6" />
        </Button>
      </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              {["Ocean", "Air", "Rail"].map((mode) => (
                <Button
                  ...
                  variant="outline"
                  className={`p-4 h-auto rounded-xl border-2 flex-col items-center gap-2 ${
                    formData.type === mode
            ...
            {isQuoting && (
              <div className="mt-8 flex flex-col items-center justify-center p-8 bg-indigo-50 rounded-2xl border border-indigo-100">
                ...
                <p className="text-indigo-800 font-medium">
                  Calculating optimal routes and rates...
                </p>
              </div>
            )}
          </motion.div>
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-slate-500">
                Based on real-time market rates for your route.
              </p>
            </div>
              ...
              <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-slate-50">
                <div>
                  ...
                  <p className="text-4xl font-black text-indigo-600">
                    ${generatedQuote.price.toLocaleString()}{" "}
                    <span className="text-lg text-slate-400 font-medium">
                      {generatedQuote.currency}
                    </span>
                  </p>
                </div>
              ...
              <div className="p-6 grid grid-cols-2 gap-y-4 text-sm">
                <div>
                  ...
                  <span className="font-semibold text-slate-800">
                    {formData.origin} &rarr; {formData.destination}
                  </span>
                </div>
                <div>
      ...
      <div className="p-6 bg-white border-t border-slate-100 flex justify-between items-center">
        {step > 1 && step < 3 && !isQuoting ? (
          <Button
            ...
            variant="ghost"
            className="px-6 py-2.5 text-slate-600 hover:bg-slate-100"
          >
            Back
          </Button>
        ) : (
        ...
        {!isQuoting && (
          <Button
            ...
            className="px-8 py-3 rounded-xl font-bold shadow-lg shadow-indigo-600/20"
          >
            {step === 1 && "Next Step"}
