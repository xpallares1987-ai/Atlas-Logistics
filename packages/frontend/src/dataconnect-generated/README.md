...
// Variables can be defined inline as well.
const { data } = await createShipment({ trackingNumber: ..., shipperId: ..., consigneeId: ..., origin: ..., destination: ..., });
...
// Variables can be defined inline as well.
const ref = createShipmentRef({ trackingNumber: ..., shipperId: ..., consigneeId: ..., origin: ..., destination: ..., });
