  ...
  const fetchTracking = async (ref: string) => {
    ...
    try {
      const res = await fetch(
        `${import.meta.env.VITE_API_URL || ""}/api/tracking/${ref}`,
      );
      if (!res.ok) {
        if (res.status === 404)
          throw new Error(
            ...
            <div className="bg-slate-900 px-6 py-12 relative overflow-hidden flex flex-col items-center justify-center border-y border-slate-800">
              ...
              <div className="w-full max-w-lg relative h-32 flex items-center">
                ...
                <div
                  ...
                  style={{
                    left: `${trackingData.status === "DELIVERED" ? 90 : trackingData.status === "IN_TRANSIT" ? 50 : 10}%`,
                  }}
                >
                          ...
                          <div className="relative flex items-start space-x-3">
                            ...
                            <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                              ...
                              <div className="text-right text-sm whitespace-nowrap text-gray-500">
                                <time dateTime={event.milestoneDate}>
                                  {new Date(
                                    event.milestoneDate,
                                  ).toLocaleString()}
                                </time>
