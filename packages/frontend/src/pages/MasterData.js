...
function MasterData() {
  var _a = (0, react_1.useState)("schedules"),
    activeTab = _a[0],
    setActiveTab = _a[1];
        ...
        children: [
          (0, jsx_runtime_1.jsx)("div", {
            ...
            children: (0, jsx_runtime_1.jsx)("nav", {
              className: "flex -mb-px px-6 space-x-8",
              "aria-label": "Tabs",
              children: [
                {
                  id: "schedules",
          ...
          (0, jsx_runtime_1.jsxs)("div", {
            ...
            children: [
              activeTab === "schedules" &&
                (0, jsx_runtime_1.jsx)(SchedulesTab_1.SchedulesTab, {}),
              activeTab === "vessels" &&
                (0, jsx_runtime_1.jsx)(VesselsTab_1.VesselsTab, {}),
              activeTab === "incoterms" &&
                (0, jsx_runtime_1.jsx)(IncotermsTab_1.IncotermsTab, {}),
              activeTab === "hscodes" &&
                (0, jsx_runtime_1.jsx)(HsCodesTab_1.HsCodesTab, {}),
              activeTab === "dictionary" &&
                (0, jsx_runtime_1.jsx)(DictionaryTab_1.DictionaryTab, {}),
            ],
          }),
        ],
      }),
