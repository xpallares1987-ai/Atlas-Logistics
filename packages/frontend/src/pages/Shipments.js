...
function Shipments() {
  var _this = this;
  var embarques = (0, dexie_react_hooks_1.useLiveQuery)(function () {
    return dexie_1.db.embarques.toArray();
  });
  if (embarques === undefined) {
    return (0, jsx_runtime_1.jsx)("div", {
      className: "text-gray-500",
      children: "Cargando embarques...",
    });
  }
  return (0, jsx_runtime_1.jsxs)("div", {
    ...
    children: [
          ...
          (0, jsx_runtime_1.jsxs)("div", {
            ...
            children: [
              (0, jsx_runtime_1.jsx)("button", {
                  ...
                  return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                      switch (_b.label) {
                        ...
                        case 2:
                          ((_a = _b.sent()),
                            (getFunctions = _a.getFunctions),
                            (httpsCallable = _a.httpsCallable));
                          app = getApp();
                          functions = getFunctions(app, "europe-west1");
                          startErpSimulation = httpsCallable(
                            functions,
                            "startErpSimulation",
                          );
                        ...
                        case 3:
                          ...
                          alert(
                            "Simulación encolada con éxito. Revisa los logs en 15 segundos.",
                          );
                          return [3 /*break*/, 5];
                        case 4:
                          e_1 = _b.sent();
                ...
                className:
                  "bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors",
                children: "Simular ERP",
              }),
              (0, jsx_runtime_1.jsx)("button", {
                className:
                  "bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors",
                children: "Nuevo Embarque",
              }),
            ],
          }),
        ],
      ...
      (0, jsx_runtime_1.jsx)("div", {
        className:
          "bg-white shadow overflow-hidden sm:rounded-lg border border-gray-200",
            ...
            (0, jsx_runtime_1.jsx)("tbody", {
              ...
              children:
                embarques.length === 0
                  ...
                  : embarques.map(function (embarque) {
                        ...
                        "tr",
                        {
                          ...
                          children: [
                            (0, jsx_runtime_1.jsx)("td", {
                              ...
                              children: embarque.numero_seguimiento,
                            }),
                            (0, jsx_runtime_1.jsx)("td", {
