...
function WorkflowsPage() {
  ...
  return (0, jsx_runtime_1.jsx)("div", {
    className:
      "w-full h-[calc(100vh-120px)] relative bpmn-modeler-wrapper bg-white shadow-sm rounded-xl overflow-hidden",
    ref: containerRef,
    dangerouslySetInnerHTML: { __html: bpmn_template_1.bpmnHtml },
  });
}
