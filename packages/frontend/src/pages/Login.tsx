...
export default function Login() {
  ...
  if (authLoading) {
    return <div className="min-h-screen flex items-center justify-center bg-slate-950 text-slate-400">Authenticating...</div>;
  }
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-950 relative overflow-hidden">
      ...
      <div className="bg-slate-900 border border-slate-800 shadow-2xl rounded-2xl w-full max-w-md p-8 relative z-10">
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-2xl font-black text-white text-center">Atlas Logistics</h2>
          <p className="text-slate-400 text-sm mt-2 text-center">Enterprise Control Tower Portal</p>
        </div>
        ...
        <form onSubmit={handleEmailLogin} className="space-y-4">
          <div>
            <label className="block text-slate-400 text-xs font-bold uppercase mb-2">Corporate Email</label>
          ...
          <div>
            <label className="block text-slate-400 text-xs font-bold uppercase mb-2">Access Token / Password</label>
            <div className="relative">
        ...
        <div className="mt-6 flex items-center">
          ...
          <span className="px-4 text-xs text-slate-500 uppercase font-bold">Or</span>
          <div className="flex-1 border-t border-slate-800"></div>
        </div>
