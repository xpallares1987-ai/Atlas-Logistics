                ...
                {quoteCart.length === 0 ? (
                  ...
                  <div className="p-2 flex flex-col gap-2">
                    {quoteCart.map((quote) => (
                      <div
                        key={quote.id}
                        className="p-3 border border-slate-100 rounded-lg flex justify-between items-center bg-white hover:border-indigo-100 transition-colors"
                      >
                        <div>
                  ...
                  <Button
                    ...
                    onClick={async () => {
                      ...
                      try {
                        ...
                        doc.setFontSize(10);
                        doc.text(
                          `Reference: ATLAS-CART-${Date.now().toString().substring(7)}`,
                          130,
                          62,
                        );
                        doc.text(
                        ...
                        (doc as any).autoTable({
                          startY: 95,
                          head: [
                            ["Option", "Carrier", "Routing", "Total Amount"],
                          ],
                          body: tableData,
                          theme: "striped",
                          headStyles: {
