        ...
        <div className="flex-1 space-y-4">
          <div>
            ...
            <div className="space-y-3">
              <label
                htmlFor="pref-email-alerts"
                className="flex items-center justify-between p-3 border border-gray-800 rounded-lg bg-[#0A0A0B] cursor-pointer hover:border-gray-700 transition"
              >
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <span className="block text-[10px] text-gray-400 mt-0.5">
                      Recibir actualizaciones críticas de embarques.
                    </span>
                  </div>
                </div>
                <input
                  ...
                  onChange={(e) =>
                    onChange({ ...profile, emailAlerts: e.target.checked })
                  }
              ...
              >
                ...
                <input
                  ...
                  onChange={(e) =>
                    onChange({ ...profile, pushAlerts: e.target.checked })
                  }
                  className="rounded border-gray-700 text-blue-500 bg-[#111114] w-4 h-4"
                />
              </label>
              ...
              >
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <span className="block text-[10px] text-gray-400 mt-0.5">
                      Un reporte diario con el estatus de todos tus embarques
                      activos.
                    </span>
                  </div>
                </div>
                <input
                  ...
                  onChange={(e) =>
                    onChange({ ...profile, dailyDigest: e.target.checked })
                  }
                  className="rounded border-gray-700 text-blue-500 bg-[#111114] w-4 h-4"
                />
              </label>
