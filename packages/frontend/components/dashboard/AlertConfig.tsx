          ...
          {notifyEmail && (
            <div className="space-y-2">
              <div className="flex gap-2">
                ...
                <button
                  onClick={addEmail}
                  className="bg-gray-800 p-1.5 rounded hover:bg-gray-700"
                >
              ...
              <div className="flex flex-wrap gap-2">
                {emails.map((email) => (
                  <span
                    key={email}
                    className="bg-blue-900/30 text-blue-300 text-xs px-2 py-1 rounded flex items-center"
                  >
                    {email}
                    <button
              ...
              {[
                ...
                >
                  <input
                    ...
                    onChange={() =>
                      toggleEventType(event.key as keyof typeof eventTypes)
                    }
