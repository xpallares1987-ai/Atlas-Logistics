  ...
  return (
    <div className="bg-[#16161A] p-6 rounded-xl border border-gray-800/40 w-full flex flex-col h-[350px]">
      <div className="mb-4">
        ...
        <p className="text-xs text-gray-500 mt-1">Margen consolidado desglosado (FCL, LCL, Air, Road)</p>
      </div>
      <div className="flex-1 w-full min-h-0">
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            />
            <Bar dataKey="FCL" stackId="a" fill="#3b82f6" radius={[0, 0, 4, 4]} />
            <Bar dataKey="LCL" stackId="a" fill="#10b981" />
            <Bar dataKey="Air" stackId="a" fill="#8b5cf6" />
            <Bar dataKey="Road" stackId="a" fill="#f59e0b" radius={[4, 4, 0, 0]} />
          </BarChart>
        </ResponsiveContainer>
      </div>
    </div>
