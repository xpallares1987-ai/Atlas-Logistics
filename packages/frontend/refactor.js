...
code = code.replace(/getHistoricalBAFOilCorrelationData\(\)/g, "historicalBAFOilCorrelationData");
code = code.replace(/getHistoricalBAFNormalizedCorrelationData\(\)/g, "historicalBAFNormalizedCorrelationData");
code = code.replace(/getHistoricalDataForRoute\(\)/g, "historicalDataForRoute");
code = code.replace(/getHistoricalBaseVsBafData\(\)/g, "historicalBaseVsBafData");
code = code.replace(/getVolatilityBreakdown\(\)/g, "volatilityBreakdown");
code = code.replace(/getActiveCarriersForSelectedRoute\(\)/g, "activeCarriersForSelectedRoute");
code = code.replace(/getTop3CarriersBafVolatility\(\)/g, "top3CarriersBafVolatility");
