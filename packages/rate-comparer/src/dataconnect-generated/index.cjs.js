...
exports.listCustomers = function listCustomers(
  dcOrVars,
  varsOrOptions,
  options,
) {
...
exports.listCrmInteractions = function listCrmInteractions(
  dcOrVars,
  varsOrOptions,
  options,
) {
...
exports.listPendingOcrDocuments = function listPendingOcrDocuments(
  dcOrOptions,
  options,
) {
  const {
...
exports.listSchedules = function listSchedules(
  dcOrVars,
  varsOrOptions,
  options,
) {
...
exports.listDictionaryTerms = function listDictionaryTerms(
  dcOrOptions,
  options,
) {
  const {
...
exports.searchLocations = function searchLocations(
  dcOrVars,
  varsOrOptions,
  options,
) {
...
exports.listShipments = function listShipments(
  dcOrVars,
  varsOrOptions,
  options,
) {
...
exports.getShipmentById = function getShipmentById(
  dcOrVars,
  varsOrOptions,
  options,
) {
...
const getShipmentByTrackingNumberRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars } = validateArgs(
    connectorConfig,
    dcOrVars,
    vars,
...
exports.getShipmentByTrackingNumberRef = getShipmentByTrackingNumberRef;

exports.getShipmentByTrackingNumber = function getShipmentByTrackingNumber(
  dcOrVars,
  varsOrOptions,
  options,
) {
...
const updateShipmentTrackingRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars } = validateArgs(
    connectorConfig,
    dcOrVars,
    vars,
...
exports.updateShipmentTrackingRef = updateShipmentTrackingRef;

exports.updateShipmentTracking = function updateShipmentTracking(
  dcOrVars,
  vars,
) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(
...
exports.getUserProfile = function getUserProfile(
  dcOrVars,
  varsOrOptions,
  options,
) {
