...
describe('Metadata Schema Validation', () => {
  describe('SysMetadataSchema', () => {
    ...
    it('should fail on invalid status', () => {
      expect(() => SysMetadataSchema.parse({ status: 'invalid' })).toThrow();
    });
  ...
  describe('validateProperty', () => {
    ...
    it('should validate and parse sys:status', () => {
      expect(validateProperty('sys:status', 'delayed')).toBe('delayed');
    });

    it('should throw on invalid value', () => {
      expect(() => validateProperty('sys:status', 'extreme')).toThrow();
    });
  });
});
