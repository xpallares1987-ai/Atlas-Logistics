const { upsertUserRef, getUserRoleRef, getAllUsersRef, updateUserRoleRef, createShipmentRef, listShipmentsRef, updateShipmentStatusRef, deleteShipmentRef, connectorConfig } = require('../index.cjs.js');
