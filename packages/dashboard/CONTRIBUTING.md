# Contributing to Shipment-Dashboard

Gracias por tu interés en contribuir a **Shipment-Dashboard**. Este repositorio es un proyecto **100% independiente** dentro del ecosistema **Control Tower**.
