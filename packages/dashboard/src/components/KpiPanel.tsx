...
import { TrendingUp, TrendingDown, Minus, Package, Clock, AlertTriangle, DollarSign, BarChart2, Zap } from 'lucide-react';
...
export function KpiPanel({ metrics, isEmpty }: KpiPanelProps) {
