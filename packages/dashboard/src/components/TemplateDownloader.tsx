...
export function TemplateDownloader() {
  return (
    <div className="template-downloader mt-8 border-t border-slate-800 pt-8">
      <div className="mb-4">
        <h3 className="text-sm font-semibold text-slate-200">Need a template?</h3>
        <p className="text-xs text-slate-400">Download pre-formatted Excel templates for clean ingestion.</p>
      </div>
