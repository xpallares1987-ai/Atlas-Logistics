import { UpsertUserData, UpsertUserVariables, GetUserRoleData, GetUserRoleVariables, GetAllUsersData, UpdateUserRoleData, UpdateUserRoleVariables, CreateShipmentData, CreateShipmentVariables, ListShipmentsData, UpdateShipmentStatusData, UpdateShipmentStatusVariables, DeleteShipmentData, DeleteShipmentVariables } from '../';
...
export function useDeleteShipment(options?: useDataConnectMutationOptions<DeleteShipmentData, FirebaseError, DeleteShipmentVariables>): UseDataConnectMutationResult<DeleteShipmentData, DeleteShipmentVariables>;
export function useDeleteShipment(dc: DataConnect, options?: useDataConnectMutationOptions<DeleteShipmentData, FirebaseError, DeleteShipmentVariables>): UseDataConnectMutationResult<DeleteShipmentData, DeleteShipmentVariables>;
