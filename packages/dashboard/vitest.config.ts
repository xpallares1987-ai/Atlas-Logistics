...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@torre/shared/assets': path.resolve(__dirname, './packages/shared/assets'),
      '@torre/shared': path.resolve(__dirname, './packages/shared/src/index.ts'),
      '@torre/ui/assets': path.resolve(__dirname, './packages/ui/assets'),
      '@torre/ui': path.resolve(__dirname, './packages/ui/src/index.ts'),
      '@control-tower/workers': path.resolve(__dirname, './src/workers/pool.ts'),
