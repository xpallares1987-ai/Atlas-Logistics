...
```
This allows the browser to perform cross-fades and shared-element transitions during tab switches (e.g., from *Overview* to *Live Tracker*) using GPU-accelerated snapshots, preventing Layout Shift (CLS) and reducing the perceived load time.
