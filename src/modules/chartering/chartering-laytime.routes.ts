  ...
  fastify.post("/calculate-laytime", async (request, reply) => {
    try {
      ...
      if (
        ...
        void domainEventBus.publish("chartering:laytime-calculated", calcId, {
          fixtureId: body.charterPartyId,
          vesselName: body.vesselName || "Unknown Vessel",
          demurrageDueEur: calculation.totalDemurrageAmountUsd,
          despatchDueEur: calculation.totalDespatchAmountUsd,
          netSettlementEur: calculation.netFinancialPayableUsd,
        });
      }
