 ...
 */
class ValidateBookingWorker extends AtlasWorker<
  ValidateBookingInput,
  ValidateBookingOutput
> {
  ...
  async execute(job: any): Promise<ValidateBookingOutput> {
    ...
    console.log(
      `[ValidateBooking] Created DRAFT shipment: ${referenceNumber} (${newShipment.id})`,
    );
