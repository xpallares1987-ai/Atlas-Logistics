...
**Clarification:** This decision applies _strictly_ to the internal components of `Atlas-Logistics`. It does not override the global ecosystem rule that forbids a unified monorepo across the distinct Control Tower applications (BPMN-Modeler, Freight-Comparer, etc.).
