...
4. Idioma: La aplicación es exclusiva para usuarios de habla hispana. No es necesario el multilingüe para esta aplicación, solo español. Todas las interfaces, textos y respuestas deben ser en español (España).
