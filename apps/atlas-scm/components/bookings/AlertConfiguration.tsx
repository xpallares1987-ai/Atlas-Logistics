      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <label className="flex items-center cursor-pointer">
          <div className="relative">
            ...
            />
            <div
              className={`block w-10 h-6 rounded-full transition-colors duration-300 ${notificationsEnabled ? "bg-blue-500" : "bg-gray-700"}`}
            ></div>
            <div
              className={`dot absolute left-1 top-1 bg-white w-4 h-4 rounded-full transition-transform duration-300 ${notificationsEnabled ? "transform translate-x-4" : ""}`}
            ></div>
          </div>
        </label>
      </div>
      ...
      {notificationsEnabled ? (
        <div className="space-y-4 animate-in fade-in zoom-in-95 duration-200">
          <p className="text-xs text-gray-400">
            Recibe notificaciones preventivas antes de que se cumpla la fecha
          ...
          <div className="bg-[#0A0A0B] border border-gray-800 rounded-lg p-4 space-y-4">
            <div>
              <label
                htmlFor="threshold-days-select"
                className="block text-xs font-medium text-gray-400 mb-2 flex items-center"
              >
                <Clock className="w-3.5 h-3.5 mr-1.5" /> Umbral de Notificación
                Preventiva
              </label>
            ...
            <div className="pt-3 border-t border-gray-800/50 space-y-3">
              <label
                htmlFor="email-enabled-checkbox"
                className="flex items-start p-3 border border-gray-800 rounded-lg bg-[#111114] cursor-pointer hover:border-gray-700 transition"
              >
                ...
                <div className="ml-3 flex-1">
                  <span className="text-xs font-medium text-gray-300 flex items-center mb-1">
              ...
              <label
                htmlFor="push-enabled-checkbox"
                className="flex items-center justify-between p-3 border border-gray-800 rounded-lg bg-[#111114] cursor-pointer hover:border-gray-700 transition"
              >
                <div>
                  ...
                  <p className="text-[10px] text-gray-400 mt-0.5">
                    Recibir notificaciones directamente en el dispositivo móvil.
                  </p>
                </div>
                <input
                  type="checkbox"
        ...
        <div className="text-xs text-gray-400 text-center py-4 bg-[#0A0A0B] rounded-lg border border-gray-800/50">
          Las notificaciones preventivas y alertas de ETA están desactivadas
          para este embarque.
        </div>
      )}
    </div>
